...
# ---------------------------------------------------------------
TEMPLATE_PATH_FLASK = "base/hpa-flask_template.yaml"     # Plantilla base con placeholders
TEMPLATE_PATH_NGINX = "base/hpa-nginx_template.yaml"     # Plantilla base con placeholders
...
# ---------------------------------------------------------------
with open(TEMPLATE_PATH_FLASK, "r") as file:
...
for case_id, (min_r, max_r, target_cpu) in combinations.items():
    ...
    output_path = os.path.join(OUTPUT_DIR, f"{case_id}_flask_hpa.yaml")
...
# LECTURA DEL ARCHIVO DE PLANTILLA
# ---------------------------------------------------------------
with open(TEMPLATE_PATH_NGINX, "r") as file:
    template_content = file.read()
...
for case_id, (min_r, max_r, target_cpu) in combinations.items():
    ...
    # Ruta del archivo de salida
    output_path = os.path.join(OUTPUT_DIR, f"{case_id}_nginx_hpa.yaml")
