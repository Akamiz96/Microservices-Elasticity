...
#              durante la ejecución del microbenchmark. Guarda los resultados en un
#              archivo CSV fijo como referencia para estimar el uso promedio de recursos.
#
...
DEPLOYMENT_NAME="nginx-test"                              # Deployment objetivo
